> **Provenance:** Historical performance report generated by the old `ish-arm64` x86-vs-ARM64 benchmark harness on 2026-04-18. Moved from `benchmark/` to `docs/benchmark/` during the `ios-linuxkit` documentation consolidation on 2026-05-16; the x86 comparison harness has since been retired from the ARM64-only tree.
>
