> **Provenance:** Historical performance report generated by the `ish-arm64` benchmark harness on 2026-04-18. Moved from `benchmark/` to `docs/benchmark/` during the `ios-linuxkit` documentation consolidation on 2026-05-16; benchmark scripts/assets remain under `benchmark/`.
>
